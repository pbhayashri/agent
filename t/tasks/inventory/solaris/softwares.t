...
use AssetSync::Agent::Task::Inventory::Solaris::Softwares;
...
foreach my $test (keys %pkg_tests) {
    ...
    my $softwares = AssetSync::Agent::Task::Inventory::Solaris::Softwares::_parse_pkgs(file => $file, command => 'pkg info');
...
foreach my $test (keys %pkginfo_tests) {
    my $file = "resources/solaris/pkg-info/$test";
    my $softwares = AssetSync::Agent::Task::Inventory::Solaris::Softwares::_parse_pkgs(file => $file, command => 'pkginfo -l');
