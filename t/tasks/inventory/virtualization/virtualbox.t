...
use AssetSync::Agent::Task::Inventory::Virtualization::VirtualBox;
...
foreach my $test (keys %tests) {
    ...
    my @machines = AssetSync::Agent::Task::Inventory::Virtualization::VirtualBox::_parseVBoxManage(file => $file);
