...
use AssetSync::Agent::Task::Inventory::BSD::Storages::Megaraid;
...
foreach my $test (keys %tests_mfiutil) {
    ...
    my @results = AssetSync::Agent::Task::Inventory::BSD::Storages::Megaraid::_parseMfiutil(file => $file);
...
for my $test (keys %$tests_sysctl) {
    ...
    my @results = sort { $a->{NAME} cmp $b->{NAME} } AssetSync::Agent::Task::Inventory::BSD::Storages::_getStorages(%params);
