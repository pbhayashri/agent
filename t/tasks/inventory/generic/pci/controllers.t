...
use AssetSync::Agent::Task::Inventory::Generic::PCI::Controllers;
...
foreach my $test (keys %tests) {
    ...
    my @controllers = AssetSync::Agent::Task::Inventory::Generic::PCI::Controllers::_getControllers(file => $file, datadir => 'share');
