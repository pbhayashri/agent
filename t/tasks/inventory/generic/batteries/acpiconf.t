...
use AssetSync::Agent::Task::Inventory::Generic::Batteries::Acpiconf;
...
foreach my $test (keys %testAcpiconfInfos) {
    my $battery = AssetSync::Agent::Task::Inventory::Generic::Batteries::Acpiconf::_getBatteryFromAcpiconf(
