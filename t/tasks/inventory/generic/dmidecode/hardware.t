...
use AssetSync::Agent::Task::Inventory::Generic::Dmidecode::Hardware;
...
foreach my $test (keys %tests) {
    ...
    my $hardware = AssetSync::Agent::Task::Inventory::Generic::Dmidecode::Hardware::_getHardware(file => $file);
