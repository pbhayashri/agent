...
AssetSync::Agent::Task::Inventory::Win32::Storages->require();
...
my $module = Test::MockModule->new(
    'AssetSync::Agent::Task::Inventory::Win32::Storages'
);
...
foreach my $test (sort keys %tests) {
    ...
    $storages = AssetSync::Agent::Task::Inventory::Win32::Storages::_getDrives(
