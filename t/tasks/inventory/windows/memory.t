...
AssetSync::Agent::Task::Inventory::Win32::Memory->require();
...
my $module = Test::MockModule->new(
    'AssetSync::Agent::Task::Inventory::Win32::Memory'
);
...
foreach my $test (keys %tests) {
    ...
    my @memories = AssetSync::Agent::Task::Inventory::Win32::Memory::_getMemories();
    cmp_deeply(
        \@memories,
        $tests{$test},
        "$test: parsing"
