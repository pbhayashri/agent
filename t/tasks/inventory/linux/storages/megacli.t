...
use AssetSync::Agent::Task::Inventory::Linux::Storages::Megacli;
...
foreach my $test (keys %pdlist_tests) {
    ...
    my $results = AssetSync::Agent::Task::Inventory::Linux::Storages::Megacli::_getPDlist(file => $file);
    cmp_deeply($results, $pdlist_tests{$test}, "$test: megacli -PDlist parsing");
}

foreach my $test (keys %summary_tests) {
    my $file = "resources/linux/megacli/$test";
    my $results = AssetSync::Agent::Task::Inventory::Linux::Storages::Megacli::_getSummary(file => $file);
    cmp_deeply($results, $summary_tests{$test}, "$test: megacli -ShowSummary parsing");
}

foreach my $test (keys %enclosure_tests) {
    my $file = "resources/linux/megacli/$test";
    my $results = AssetSync::Agent::Task::Inventory::Linux::Storages::Megacli::_getAdpEnclosure(file => $file);
...
foreach my $test (keys %storage_tests) {
    ...
    my $adapter = AssetSync::Agent::Task::Inventory::Linux::Storages::Megacli::_getAdpEnclosure(file => $file);
    $file = "resources/linux/megacli/${test}_PDlist";
    my $pdlist = AssetSync::Agent::Task::Inventory::Linux::Storages::Megacli::_getPDlist(file => $file);
    $file = "resources/linux/megacli/${test}_ShowSummary";
    my $summary = AssetSync::Agent::Task::Inventory::Linux::Storages::Megacli::_getSummary(file => $file);
    my $results = AssetSync::Agent::Task::Inventory::Linux::Storages::Megacli::_getStorages($adapter,$pdlist,$summary);
