...
use AssetSync::Agent::Task::Inventory::Linux::Storages::MegacliWithSmartctl;
...
foreach my $test (keys %pdlist_tests) {
    ...
    my $results = AssetSync::Agent::Task::Inventory::Linux::Storages::MegacliWithSmartctl::_getPDlist(file => $file);
    cmp_deeply($results, $pdlist_tests{$test}, "$test: `megacli -PDlist' parsing");
}

foreach my $test (keys %ldinfo_tests) {
    my $file = "resources/linux/megacli/$test";
    my $results = AssetSync::Agent::Task::Inventory::Linux::Storages::MegacliWithSmartctl::_getLDinfo(file => $file);
    cmp_deeply($results, $ldinfo_tests{$test}, "$test: `megacli -LDInfo -lAll' parsing");
}

foreach my $test (keys %adppciinfo_tests) {
    my $file = "resources/linux/megacli/$test";
    my $results = AssetSync::Agent::Task::Inventory::Linux::Storages::MegacliWithSmartctl::_getAdpPciInfo(file => $file);
