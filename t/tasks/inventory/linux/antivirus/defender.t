...
use AssetSync::Agent::Task::Inventory::Linux::AntiVirus::Defender;
...
foreach my $test (keys %av_tests) {
    ...
    my $antivirus = AssetSync::Agent::Task::Inventory::Linux::AntiVirus::Defender::_getMSDefender(file => $file);
