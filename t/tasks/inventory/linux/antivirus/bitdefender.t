...
use AssetSync::Agent::Task::Inventory::Linux::AntiVirus::Bitdefender;
...
foreach my $test (keys %av_tests) {
    ...
    my $antivirus = AssetSync::Agent::Task::Inventory::Linux::AntiVirus::Bitdefender::_getBitdefenderInfo(file => $file);
