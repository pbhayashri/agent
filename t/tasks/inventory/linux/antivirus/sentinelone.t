...
use AssetSync::Agent::Task::Inventory::Linux::AntiVirus::Sentinelone;
...
foreach my $test (keys %av_tests) {
    ...
    my $antivirus = AssetSync::Agent::Task::Inventory::Linux::AntiVirus::Sentinelone::_getSentineloneInfo(file => $file);
