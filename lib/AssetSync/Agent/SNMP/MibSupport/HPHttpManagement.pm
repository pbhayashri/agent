package AssetSync::Agent::SNMP::MibSupport::HPHttpManagement;
...
AssetSync::Agent::SNMP::MibSupport::HPHttpManagement - Inventory module for HP switchs with HTTP management
