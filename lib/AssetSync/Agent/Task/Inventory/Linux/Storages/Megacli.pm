package AssetSync::Agent::Task::Inventory::Linux::Storages::Megacli;
...
our $runMeIfTheseChecksFailed = ['AssetSync::Agent::Task::Inventory::Linux::Storages::MegacliWithSmartctl'];
