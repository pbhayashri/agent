package AssetSync::Agent::Tools::PowerSupplies;
...
sub new {
    ...
    $powersupply->{logger} = AssetSync::Agent::Logger->new()
...
sub merge {
    ...
    foreach my $key (AssetSync::Agent::Tools::PowerSupplies::powersupplyFields()) {
...
AssetSync::Agent::Tools::PowerSupplies
